...
Blah.prototype.search = function (file, callback) {
    ...
    var self = this
      , tries = [
          ...
          , Path.join(self.lib_templates, "templates", file)
        ]
      ;
...
Blah.prototype.prepare = function (callback) {
    ...
    SameTime([
      ...
      , self.search.bind(self, "CONTRIBUTING.md")
      , self.search.bind(self, "blah.json")
      , function (cb) {
        ...
        self.paths.blah = data[4];
        self.paths.pack = data[5];
