...
function Blah(path) {
    ...
    this.packPath = ParentSearch(this.path, "package.json");
    if (this.packPath) {
        this.pack = ReadJson(this.packPath);
    }
    this.blahPath = ParentSearch(this.path, ".blah.json");
}
 ...
 */
Blah.prototype.getPackage = function (path) {
